...
public class Scanner {
  ...
  private void eat(char expected) throws ScanErrorException {
    ...
    else throw new ScanErrorException("illegal char: exp. " + this.currentChar + " found " + expected);
  }
  ...
  /**
   * @returns the number that currentChar is currently on
  ...
  private String scanNumber() throws ScanErrorException {
    String ret = "";
    if (!isDigit(currentChar)) throw new ScanErrorException("current char not digit: " + currentChar);
  ...
  /**
   * @returns the identifier that currentChar is currently on
  ...
  private String scanIdentifier() throws ScanErrorException {
    String ret = "";
    if (!isIdentifier(currentChar)) throw new ScanErrorException("current char not identifier: " + currentChar);
  ...
  /**
   * @returns the operator that currentChar is currently on
  ...
  private String scanOperator() throws ScanErrorException {
    String ret = "";
    if (!isOperator(currentChar)) throw new ScanErrorException("current char not operator: " + currentChar);
